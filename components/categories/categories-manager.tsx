  ...
  return (
    <article className="overflow-hidden rounded-3xl bg-white shadow-[0_16px_30px_rgba(0,0,0,0.04)]">
      <Link
        ...
        className="block aspect-4/3 bg-image-placeholder"
      >
        {coverImage ? (
          ...
          <span className="flex size-full items-center justify-center text-muted-brown">
      ...
      <div className="p-5">
        <div className="flex items-start justify-between gap-4">
          <div className="min-w-0">
            <Link
              href={`/category/${category.slug}`}
              className="block truncate text-2xl font-bold tracking-[-0.02em] text-ink transition-colors hover:text-walnut"
            >
              {category.name}
            </Link>
            <p className="mt-1 text-sm font-medium text-soft-brown">
              /{category.slug}
            </p>
          </div>
          ...
          <div className="flex shrink-0 items-center gap-1">
            <Link
              ...
              className="flex size-8 items-center justify-center rounded-lg text-quiet-ink transition-colors hover:bg-soft-linen hover:text-walnut"
            >
        ...
        <p className="mt-4 line-clamp-2 min-h-11 text-sm leading-6 text-quiet-ink">
          {category.description || "აღწერა არ არის დამატებული."}
        </p>

        <p className="mt-5 text-xs font-semibold text-soft-brown">
  ...
  return (
    <>
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-[-0.02em] text-ink lg:text-5xl">
            კატალოგი
          </h1>
        ...
        <Link
          href="/category/new"
          className="inline-flex h-11.5 w-full items-center justify-center gap-2 rounded-lg bg-walnut px-5 text-sm font-semibold text-white sm:w-auto"
        >
